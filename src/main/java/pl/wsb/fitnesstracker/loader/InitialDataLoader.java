 ...
 * data,
 * for the manual testing purposes. Loader is triggered by
 * {@link ContextRefreshedEvent } event
 */
@Component
...
class InitialDataLoader {
        ...
        public void loadInitialData(ContextRefreshedEvent event) {
                ...
                List<Object[]> eventCounts = eventRepository.findEventNamesWithEnrolledCount();

                for (Object[] row : eventCounts) {
                        String name = (String) row[0];
                        Number count = (Number) row[1];
                        System.out.println("Wydarzenie: " + name + " | Zapisanych osób: " + count);
                }
                System.out.println("====================================");
